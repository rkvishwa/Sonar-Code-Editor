        ...
        const establishBindingToYText = (targetYText: Y.Text) => {
          ...
          const publishCursor = () => {
            ...
            awareness.setLocalStateField("selection", {
              anchor: Y.createRelativePositionFromTypeIndex(targetYText, anchor),
              head: Y.createRelativePositionFromTypeIndex(targetYText, head),
            });
          };
          ...
          // 2. Render remote cursor decorations
            ...
            awareness.getStates().forEach((state: any, clientID: number) => {
              if (
                ...
                if (
                  anchorAbs !== null &&
                  headAbs !== null &&
                  anchorAbs.type === targetYText &&
                  headAbs.type === targetYText
                ) {
          ...
          // 3. Clear remote cursors on specific remote user disconnect
          ...
          targetYText.observe(ytextDecorObserver);
          ...
          return () => {
            ...
            targetYText.unobserve(ytextDecorObserver);
            try {
              if (monacoEditor.getModel() === model) {
